...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Beat Magic" },
      { name: "description", content: "Create professional AI-powered beat-synced videos in seconds. Perfect sync, no manual editing required!\"" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Beat Magic" },
      { property: "og:description", content: "Create professional AI-powered beat-synced videos in seconds. Perfect sync, no manual editing required!\"" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Beat Magic" },
